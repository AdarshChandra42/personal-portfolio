  ...
  const journeyData = [
    {
      ...
      description: "Focused on software engineering, AI, and web development. Graduated with honors.",
    },
    {
      icon: "💼",
      date: "Summer 2023",
      ...
      description: "Developed features for a large-scale SaaS platform, working with Agile methodologies.",
    },
    {
      icon: "⚡",
      date: "2024 - Present",
      title: "Exploring Advanced Three.js & WebXR",
      institution: "Self-Study & Projects",
      description: "Deepening expertise in 3D web graphics and immersive experiences.",
    },
    {
      icon: "🎓",
      date: "Ongoing",
